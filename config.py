...
output_with_angle_path = [
    "~/Video/bvh_analysis/output/bigman",
    "~/Video/bvh_analysis/output/me1",
    "~/Video/bvh_analysis/output/me4",
    "~/Video/bvh_analysis/output/me5",
    "~/Video/bvh_analysis/output/rookie2",
    "~/Video/bvh_analysis/output/small_rotation_edit",
]
